...
def init_database():
    ...
    try:
        ...
        # Create Users
        users = [
            models.User(id='u1', name='Sarah Chen', email='sarah@example.com', role='admin', availability=True),
            models.User(id='u2', name='Marcus Thompson', email='marcus@example.com', role='member', availability=True),
            models.User(id='u3', name='Elena Rodriguez', email='elena@example.com', role='member', availability=True),
            models.User(id='u4', name='James Wilson', email='james@example.com', role='member', availability=False),
            models.User(id='u5', name='Priya Patel', email='priya@example.com', role='viewer', availability=True),
        ]
        db.add_all(users)
        print("✓ Users created")
